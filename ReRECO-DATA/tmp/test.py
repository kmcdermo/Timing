...
# with command line options: ReRECO --data --scenario pp --era Run2_2016 --process reRECO --filtername RECOfromRECO -s RECO --eventcontent AOD --datatier AOD --conditions 80X_dataRun2_2016SeptRepro_v3 --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016,RecoTracker/Configuration/customizeMinPtForHitRecoveryInGluedDet.customizeHitRecoveryInGluedDetOn --runUnscheduled --filein file:/afs/cern.ch/work/k/kmcdermo/files/RECO/test_2016B.root --fileout file:rereco_test.root --no_exec -n 100
