...
# with command line options: step3 --data --eventcontent MINIAOD --runUnscheduled --datatier MINIAOD --step PAT --conditions 80X_dataRun2_2016SeptRepro_v4 --filein file:/afs/cern.ch/work/k/kmcdermo/files/RECO/regular_reco_deg_2016B.root --fileout file:reco_deg_2016B_MINIAOD.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/k/kmcdermo/files/RECO/regular_reco_deg_2016B.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:regular_reco_deg_2016B_MINIAOD.root'),
