...
# with command line options: RAWtoAOD --data --era Run2_2016 --runUnscheduled -s RAW2DIGI,L1Reco,RECO --eventcontent AOD --datatier AOD --conditions 80X_dataRun2_Prompt_v14 --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016 --filein /store/data/Run2016H/DoubleEG/RAW/v1/000/284/035/00000/0420ABEC-CB9E-E611-90D3-FA163E8EFA4E.root --fileout file:reco_test.root --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2016H/DoubleEG/RAW/v1/000/284/035/00000/0420ABEC-CB9E-E611-90D3-FA163E8EFA4E.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('RAWtoAOD nevts:100'),
