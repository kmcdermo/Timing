...
# with command line options: OOT --data --era Run2_2016 --runUnscheduled --step PAT --eventcontent MINIAOD --datatier MINIAOD --conditions 80X_dataRun2_Prompt_v14 --filein file:oot_aod_100.root --fileout file:oot_miniaod2.root --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/k/kmcdermo/public/files/RECO/OOT_Sequence/oot_aod_1000.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('OOT nevts:100'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/afs/cern.ch/work/k/kmcdermo/public/files/RECO/OOT_Sequence/oot_miniaod_1000.root'),
