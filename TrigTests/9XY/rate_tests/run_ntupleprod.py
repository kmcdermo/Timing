...
options.register('doL1Prescales', False, #default value
                 VarParsing.VarParsing.multiplicity.singleton,VarParsing.VarParsing.varType.bool,"")

options.register('L1PrescaleColumn', 2, #default value
...
# /users/kmcdermo/TargetPath91X/DisplacedPhotonHT/V4 (CMSSW_9_1_0_pre3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/kmcdermo/TargetPath91X/DisplacedPhotonHT/V4')
)
...
#        '/store/mc/PhaseIFall16DR/QCD_Pt-120to170_EMEnriched_TuneCUETP8M1_13TeV_pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/00000/00AAEB84-7C07-E711-B9A2-0CC47A7C3572.root',
    ),
