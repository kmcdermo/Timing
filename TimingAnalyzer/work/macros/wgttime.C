...
void wgttime()
{
  ...
  TH1F * h_seedtimeTOF = new TH1F("h_seedtimeTOF",Form("%s seed time [TOF]",el.Data()),100,-5.0,5.0);
  ...
  TH1F * h_weighttime  = new TH1F("h_weighttime",Form("%s weighted time",el.Data()),100,-5.0,5.0);
