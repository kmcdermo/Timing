...
xblind=${4:-""}
yblind=${5:-""}
extra_shift=${6:-"0"} # ns for time unc
...
echo "x_var_data=+phoweightedtimeLT120SHIFT_0+${extra_shift}" >> "${plot_config}"
echo "x_var_sign=+phoweightedtimeLT120SHIFT_0+phoweightedtimeLT120SMEAR_0+${extra_shift}" >> "${plot_config}"
