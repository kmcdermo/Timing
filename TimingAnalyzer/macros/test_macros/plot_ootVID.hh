...
namespace Config
{
  ...
  static const std::map<CutType,Observable> observables =
  {
    ...
    {CutType::smaj,{"max(phosmaj_0-(0.1407*(abs(phosceta_0)-0.8))*((abs(phosceta_0)>=0.8)*(abs(phosceta_0)<1.4442))-(0.1054*exp(-0.01662*phopt_0+1.333)),0.0)","<","0.4","0.29","smaj","S_{Major}"}} // !!!! used to be 0.5 for tight !!!
  };
