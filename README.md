...
From here, we can issue a set of cmsDriver commands to autogenerate python configs. To run locally, we will need a GEN_SIM ROOT file from step0 as input into step1. Make sure to test each autogenerated config locally with cmsRun before submitting to CRAB!
...
Further Documentation:
 * cmsDriver.py for step0 must be launched from CMSSW_7_1_25/src/ in order to properly pickup Configuration/
