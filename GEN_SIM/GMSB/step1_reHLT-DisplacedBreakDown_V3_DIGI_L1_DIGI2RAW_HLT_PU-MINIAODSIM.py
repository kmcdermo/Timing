...
# with command line options: reHLT -s DIGI,L1,DIGI2RAW,HLT:hltdev:/users/kmcdermo/TestDev/DisplacedBreakDown/V3 --processName HLT3 --mc --datatier MINIAODSIM --eventcontent MINIAODSIM --era Run2_2016 --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --python_filename step1_reHLT-DisplacedBreakDown_V3_DIGI_L1_DIGI2RAW_HLT_PU-MINIAODSIM.py --filein file:PAT-MINIAODSIM.root --secondfilein file:GMSB_L180_Ctau6000_Pythia8_13TeV_GEN_SIM-RAWSIM.root --fileout file:reHLT-BreakDown-PAT-MINIAODSIM.root --pileup 2016_25ns_Moriond17MC_PoissonOOTPU --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIISummer15GS-MCRUN2_71_V1_ext1-v1/GEN-SIM -n 1 --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('HLT3',eras.Run2_2016)
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:reHLT-BreakDown-PAT-MINIAODSIM.root'),
...
process.loadHltConfiguration("hltdev:/users/kmcdermo/TestDev/DisplacedBreakDown/V3",type='GRun')
