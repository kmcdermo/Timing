...
# with command line options: step3_mc --conditions auto:run2_mc --mc --scenario pp --process PAT --era Run2_2016,run2_miniAOD_80XLegacy --eventcontent MINIAODSIM --runUnscheduled -s PAT --datatier MINIAODSIM --filein file:RAW2DIGI_L1Reco_RECO-AODSIM.root --fileout file:step3.root --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/kmcdermo/GMSB_L180_Ctau6000_Pythia8_13TeV_cff_py_GEN_SIM/GMSB_L180_Ctau6000_userHLT_RAW2DIGI_L1Reco_RECO-AODSIM-v1/170625_133709/0000/RAW2DIGI_L1Reco_RECO-AODSIM_99.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_mc.root'),
