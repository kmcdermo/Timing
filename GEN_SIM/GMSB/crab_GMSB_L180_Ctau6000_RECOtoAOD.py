...
config.General.requestName   = 'GMSB_L180_Ctau6000_AOD-v3'
config.General.workArea      = 'crab_projects'

config.JobType.pluginName    = 'Analysis'
config.JobType.psetName      = 'step2p5_RECOtoAOD.py'
...
config.Data.outputDatasetTag = 'GMSB_L180_Ctau6000_AOD-v3'
