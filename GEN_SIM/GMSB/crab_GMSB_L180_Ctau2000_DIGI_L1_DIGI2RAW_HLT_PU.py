...
config.General.requestName = 'GMSB_L180_Ctau2000_userHLT_DIGI_L1_DIGI2RAW_HLT_PU-RAWSIM-v1'
...
config.Data.outputDatasetTag = 'GMSB_L180_Ctau2000_userHLT_DIGI_L1_DIGI2RAW_HLT_PU-RAWSIMv1'
