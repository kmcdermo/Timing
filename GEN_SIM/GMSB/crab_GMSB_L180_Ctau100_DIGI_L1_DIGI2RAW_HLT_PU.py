...
config.General.requestName = 'GMSB_L180_Ctau100_newHLT_DIGI_L1_DIGI2RAW_HLT_PU-v1'
...
config.Data.outputDatasetTag = 'GMSB_L180_Ctau100_newHLT_DIGI_L1_DIGI2RAW_HLT_PU-v1'
