...
# with command line options: step2 --mc --eventcontent AODSIM --datatier AODSIM --conditions 93X_mc2017_realistic_v3 --step RAW2DIGI,RECO,EI --nThreads 4 --era Run2_2017 --filein file:step1.root --fileout file:step2.root
