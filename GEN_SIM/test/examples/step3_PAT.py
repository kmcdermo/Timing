...
# with command line options: step3 --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 93X_mc2017_realistic_v3 --step PAT --nThreads 4 --era Run2_2017 --filein file:step2.root --fileout file:step3.root
