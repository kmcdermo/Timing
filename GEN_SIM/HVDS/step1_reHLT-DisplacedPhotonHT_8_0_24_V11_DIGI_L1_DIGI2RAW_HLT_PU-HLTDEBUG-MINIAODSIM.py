...
# with command line options: reHLT -s DIGI,L1,DIGI2RAW,HLT:hltdev:/users/kmcdermo/TestDev/DisplacedPhotonHT_8_0_24/V11 --processName HLT4 --mc --datatier HLTDEBUG --eventcontent HLTDEBUG --era Run2_2016 --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --python_filename step1_reHLT-DisplacedPhotonHT_8_0_24_V11_DIGI_L1_DIGI2RAW_HLT_PU-HLTDEBUG-MINIAODSIM.py --filein file:PAT-MINIAODSIM.root --secondfilein file:HVDS_13TeV_ctau1000_GEN_SIM-RAWSIM.root --fileout file:reHLT4-PAT-MINIAODSIM.root --pileup 2016_25ns_Moriond17MC_PoissonOOTPU --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIISummer15GS-MCRUN2_71_V1_ext1-v1/GEN-SIM -n 1 --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    secondaryFileNames = cms.untracked.vstring('file:HVDS_13TeV_ctau1000_GEN_SIM-RAWSIM.root')
)
...
process.HLTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:reHLT4-PAT-MINIAODSIM.root'),
